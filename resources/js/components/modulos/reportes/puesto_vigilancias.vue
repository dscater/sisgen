    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Reportes - Lista de Puestos de Vigilancia</h1>
                    </div>
                </div>
            </div>
        </section>
...
export default {
    data() {
        return {
            ...
            listFiltro: ["Todos", "Puesto de Vigilancia"],
            listPuestos: [],
            errors: [],
        };
    },
    ...
    methods: {
        ...
        generaReporte() {
            ...
            axios
                .post("/admin/reportes/puesto_vigilancias", this.oReporte, config)
                .then((res) => {
                    this.errors = [];
                    this.enviando = false;
