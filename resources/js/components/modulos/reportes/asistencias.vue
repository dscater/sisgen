    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Reportes - Registro de Asistencia</h1>
                    </div>
                </div>
            </div>
        </section>
...
export default {
    data() {
        return {
            ...
            listFiltro: ["Todos", "Personal", "Rango de fechas"],
            listPersonal: [],
            errors: [],
        };
    },
    ...
    methods: {
        limpiarFormulario() {
            ...
            this.oReporte.personal = "";
        },
        // Listar Personals
        getPersonals() {
            let url = "/admin/personals";
            axios.get(url).then((res) => {
                this.listPersonal = res.data.personals;
            });
        },
        generaReporte() {
            this.enviando = true;
            ...
            axios
                .post("/admin/reportes/asistencias", this.oReporte, config)
                .then((res) => {
                    this.errors = [];
                    this.enviando = false;
