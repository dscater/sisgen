...
class UserController extends Controller
{
    ...
    public $permisos = [
        'ADMINISTRADOR' => [
            ...
            'puesto_vigilancias.index',
            'puesto_vigilancias.create',
            'puesto_vigilancias.edit',
            'puesto_vigilancias.destroy',
    ...
    public function update(Request $request, User $usuario)
    {
        ...
        $usuario->update(array_map('mb_strtoupper', $request->except('tipo', 'foto')));
        if ($usuario->correo == "") {
            $usuario->correo = NULL;
        }
    ...
    public function getInfoBox()
    {
        ...
        if (in_array('puesto_vigilancias.index', $this->permisos[$tipo])) {
            $array_infos[] = [
                'label' => 'Puestos de Vigilancia',
                'cantidad' => count(PuestoVigilancia::all()),
                'color' => 'bg-primary',
                'icon' => 'fa fa-list',
            ];
        }
